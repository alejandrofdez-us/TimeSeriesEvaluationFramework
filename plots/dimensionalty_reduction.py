...
class DimensionalityReduction(Plot):
    ...
    def initialize(self, similarity_ts, ts2_filename):
        ...
        self.ts1_reduced_dimensions, self.ts2_reduced_dimensions = self.reduce_tss_dimensionality(
    ...
    def reduce_ts_dimensionality_refactored(self, ts):  # FIXME: valorar el uso del que tenemos u otro nuevo
        seq_len = ts.shape[1]
